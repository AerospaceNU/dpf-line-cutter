...
public:
  ...
  bool begin()
  {
    ...
    // Set gyro fullscale to 1000 degrees per second? or FS_SEL=2
    // That means it's 32.8 lsb/dps
    // Old data is at 250deg/sec, or a sensitivity of 131LSB/DPS
    Write8(0x1B, 0b00010000, address);   
  ...
  imu_out_t readout()
  {
    ...
    // Gyro is 32.8 lsb/dps
    float gyroSense = 32.8;
    return {
